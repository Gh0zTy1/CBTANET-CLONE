...
import type { ZardCommandOptionGroupComponent } from '@/shared/components/base/command/command-option-group.component';
import { ZardCommandComponent } from '@/shared/components/base/command/command.component';
import {
  commandItemVariants,
  commandShortcutVariants,
  type ZardCommandItemVariants,
} from '@/shared/components/base/command/command.variants';
