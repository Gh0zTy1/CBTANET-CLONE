...
import { ZardButtonComponent, type ZardButtonTypeVariants } from '@/shared/components/base/button';
import { ZardCalendarComponent } from '@/shared/components/base/calendar';
import type { ZardDatePickerSizeVariants } from '@/shared/components/base/date-picker/date-picker.variants';
...
@Component({
  selector: 'z-date-picker-icon, [z-date-picker-icon]',
  ...
  providers: [
    DatePipe,
    {
      ...
      useExisting: forwardRef(() => ZardDatePickerIconComponent),
      multi: true,
    },
  ],
...
export class ZardDatePickerIconComponent implements ControlValueAccessor {
