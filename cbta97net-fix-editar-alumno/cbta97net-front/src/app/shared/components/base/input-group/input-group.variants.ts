    ...
    compoundVariants: [
      {
        zType: 'default',
        zSize: 'default',
        class: 'h-10', //change this
      },
      {
        zType: 'default',
        zSize: 'sm',
        class: 'h-9', //change this
      },
      {
        zType: 'default',
        zSize: 'lg',
        class: 'h-11', //change this
      },
      {
        zType: 'textarea',
        zPosition: 'before',
...
export const inputGroupInputVariants = cva(
  ...
  ),
  {
    variants: {
      zSize: {
        sm: 'h-full px-0.5 py-0 text-xs', //change this
        default: 'h-full px-0.5 py-0 text-sm', //change this
        lg: 'h-full px-0.5 py-0 text-base', //change this
      },
      zHasAddonBefore: {
