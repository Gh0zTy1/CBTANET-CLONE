...
export const tableVariants = cva(
  'w-full caption-bottom text-(length:--text-sm) [&_thead_tr]:border-b [&_tbody]:border-0 [&_tbody_tr:last-child]:border-0 [&_tbody_tr]:border-b [&_tbody_tr]:transition-colors [&_tbody_tr]:hover:bg-muted/50 [&_tbody_tr]:data-[state=selected]:bg-muted [&_th]:h-10 [&_th]:px-2 [&_th]:text-left [&_th]:align-middle [&_th]:font-medium [&_th]:text-muted-foreground [&_th:has([role=checkbox])]:pr-0 [&_th>[role=checkbox]]:translate-y-0.5 [&_td]:p-2 [&_td]:align-middle [&_td:has([role=checkbox])]:pr-0 [&_td>[role=checkbox]]:translate-y-0.5 [&_caption]:mt-4 [&_caption]:text-(length:--text-sm) [&_caption]:text-muted-foreground',
  {
    variants: {
      zType: {
        default: '',
...
export const tableCaptionVariants = cva('mt-4 text-(length:--text-sm) text-muted-foreground', {
  variants: {},
  defaultVariants: {},
});
